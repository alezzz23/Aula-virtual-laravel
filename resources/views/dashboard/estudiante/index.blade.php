...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-user-graduate"></i> Dashboard - Estudiante</h1>
</div>
            ...
            <div class="card-body">
                @forelse($materias as $materia)
                    <div class="mb-3">
                        ...
                        <p class="mb-1">
                            <strong>Profesor:</strong> {{ $materia->profesor->usuario }}
                        </p>
                        <div class="btn-group btn-group-sm" role="group">
                            <a href="{{ route('materias.actividades', $materia) }}" class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-file-alt"></i> Ver Actividades
                            </a>
                            <a href="{{ route('materias.tareas', $materia) }}" class="btn btn-sm btn-outline-info">
                                <i class="fas fa-tasks"></i> Tareas
                            </a>
                            <a href="{{ route('reportes.index', $materia) }}" class="btn btn-sm btn-outline-secondary">
                ...
                @empty
                    <p class="text-muted">No estás inscrito en ninguna materia.</p>
                @endforelse
            </div>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            <div class="card-header bg-success text-white">
                <h5 class="card-title mb-0"><i class="fas fa-graduation-cap"></i> Mis Notas</h5>
            </div>
            <div class="card-body text-center">
                <a href="{{ route('usuarios.boleta', auth()->id()) }}" class="btn btn-success">
        ...
        <div class="card mb-3">
            <div class="card-header bg-info text-white">
                <h5 class="card-title mb-0"><i class="fas fa-calendar-check"></i> Mi Asistencia</h5>
            </div>
            <div class="card-body text-center">
                <a href="{{ route('usuarios.asistencia', auth()->id()) }}" class="btn btn-info">
                    <i class="fas fa-clipboard-check"></i> Ver Asistencia
                </a>
            </div>
        </div>
